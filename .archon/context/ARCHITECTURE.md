...
- **007-version-scoped-search**: ADR-007: Version-Scoped Search as Default Behavior (Proposed)

- **008-worktree-context-binding**: ADR-008: Worktree-Per-Context Model with CLI Wrapper (Proposed)

- **009-commit-automation-pipeline**: ADR-009: Commit Automation with Staged Review (Proposed)

- **010-intelligent-auditing-system**: ADR-010: Intelligent Code Auditing System (Proposed)

- **011-audit-feedback-loop**: ADR-011: Audit Feedback Loop and Learning Mechanism (Proposed)

- **012-per-commit-context-bundle**: ADR-012: Per-Commit Context Bundle (Proposed)

- **013-skills-prompts-documentation**: ADR-013: Skills & Prompts as First-Class Documentation (Proposed)

- **014-worktree-branch-discipline**: ADR-014: Worktree and Branch Discipline (Proposed)
