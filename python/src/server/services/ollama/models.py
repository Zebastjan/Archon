"""Data models for Ollama model discovery.

This module contains all dataclasses used by the model discovery service,
including model representations, capability analysis, and health status.
"""
