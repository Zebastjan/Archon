...
describe("useInitializeRepository", () => {
	...
	it("should initialize repository and invalidate queries", async () => {
		...
		expect(mockShowToast).toHaveBeenCalledWith('Repository "test/repo" initialized successfully!', "success");
	});
	...
	it("should show error toast on failure", async () => {
		...
		expect(mockShowToast).toHaveBeenCalledWith("Failed to initialize repository: Init failed", "error");
	});
});
...
describe("useDeleteRepository", () => {
	...
	it("should delete repository and update cache", async () => {
		...
		expect(mockShowToast).toHaveBeenCalledWith("Repository removed successfully!", "success");
	});
	...
	it("should show error toast on failure", async () => {
		...
		expect(mockShowToast).toHaveBeenCalledWith("Failed to delete repository: Delete failed", "error");
	});
});
...
describe("useSyncCommits", () => {
	...
	it("should sync commits and invalidate queries", async () => {
		...
		expect(mockShowToast).toHaveBeenCalledWith('Synced 10 commits from "main"!', "success");
	});
	...
	it("should show error toast on failure", async () => {
		...
		expect(mockShowToast).toHaveBeenCalledWith("Failed to sync commits: Sync failed", "error");
	});
});
